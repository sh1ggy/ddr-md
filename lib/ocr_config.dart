...
// model. Coordinates are TL/BR in 4000×5000 warped space (rescaled from the
// source-space combined ROI via the Details-rect anchor to match the
// feature/opencv per-field ROIs below).
...
const List<int> ocrCombinedRoi = [1641, 2339, 2936, 2818];


// New — feature/opencv ROIs (4000×5000 warped space)
