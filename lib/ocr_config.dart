...
// Coordinates are read off the native 2554×1442 source screenshot. They are
// used as offsets relative to the Details rect (ocrRoi[0]): a homography maps
// the detected Details quad onto ocrRoi[0], so all ROIs only need to be mutually
// consistent (sourced from the same image) — the warp rescales into the
// 4000×5000 canvas at runtime. Do NOT mix coordinates from differently-scaled
// images.
...
// model. Coordinates are TL/BR in the native 2554×1442 source-image space.
